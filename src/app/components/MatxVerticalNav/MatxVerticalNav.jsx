...
const MatxVerticalNav = ({ items }) => {
    ...
    if (localStorage.getItem("subscription") == "sandbox"
        || localStorage.getItem("subscription") == "silver"
        || localStorage.getItem("subscription") == "bronze")
        return <div className="navigation">{renderLevels(bronze)}</div>
    else if (localStorage.getItem("subscription") == "gold")
        return <div className="navigation">{renderLevels(gold)}</div>
    else if (localStorage.getItem("subscription") == "notsubscribed")
        return <div className="navigation">{renderLevels(notsubscribed)}</div>
}
